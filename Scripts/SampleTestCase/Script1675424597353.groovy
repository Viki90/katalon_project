...
WebUI.click(findTestObject('Object Repository/Test1_OR/Page_OrangeHRM/div_Timesheets Pending Action'))

WebUI.click(findTestObject('Object Repository/Test1_OR/Page_OrangeHRM/input'))

WebUI.click(findTestObject('Object Repository/Test1_OR/Page_OrangeHRM/button_View'))

WebUI.verifyElementPresent(findTestObject('Object Repository/Test1_OR/Page_OrangeHRM/button_View'), 0)
